          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Wide Selection</h3>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Fast Shipping</h3>
                <p className="text-gray-500">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-black">Expert Advice</h3>
                <p className="text-gray-500">
