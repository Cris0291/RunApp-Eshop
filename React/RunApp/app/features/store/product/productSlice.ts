...
export const getIsProductBought = (productId: string) => (state: RootState) => state.product.boughtProducts.includes(productId);
export const getIsProductBoughtAndHasReview = (productId: string) => (state: RootState) => state.product.boughtProductsWithReviews.includes(productId);