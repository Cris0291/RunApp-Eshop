          ...
          <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 hover:text-pink-600 transition-colors duration-300">
                  {product.name}
                </h1>
                ...
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 hover:text-pink-600 transition-colors duration-300">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {product.categoryNames.map((category) => (
                      ...
                      >
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-pink-100 flex items-center justify-center group-hover:bg-pink-200 transition-colors duration-300">
                          {iconsForCategories.map((categoryIcon, index) =>
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                  {isAddedToCart ? (
                    <div className="flex-1 text-center bg-green-500 text-white py-2 rounded">
                      Your item was added
                    </div>
                  ) : (
                    <>
            ...
            {/* Product Tabs */}
            <Tabs defaultValue="features" className="mt-8 sm:mt-10">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    ...
                    {product.isBought && !product.isBoughtWithReview ? (
                      ...
                      <Button className="bg-red-500 text-white hover:bg-red-600 transition-colors duration-300 transform hover:scale-105">
                        Only Bought Products can be reviewed
                      </Button>
                    )}
                  </div>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {currentReviews === null || currentReviews.length === 0 ? (
                      ...
                      currentReviews.map((review) => (
                        <div
                          key={review.reviewId}
                          className="border-t border-gray-200 pt-4 sm:pt-6 group"
                        >
                          <div className="flex items-center mb-2 sm:mb-4">
                            <Avatar className="h-8 w-8 sm:h-10 sm:w-10 group-hover:ring-2 group-hover:ring-pink-500 transition-all duration-300">
                              <AvatarFallback>
                                {review.userName[0]}
                              </AvatarFallback>
                            </Avatar>
                            <div className="ml-3 sm:ml-4">
                              ...
                              <div className="flex items-center">
                                ...
                                <span className="ml-2 text-xs sm:text-sm text-gray-500 group-hover:text-pink-500 transition-colors duration-300">
                                  {review.date}
                                </span>
                              </div>
                            </div>
                          </div>
                          <p className="text-sm sm:text-base text-gray-600 mb-2 sm:mb-4 group-hover:text-gray-800 transition-colors duration-300">
                            {review.comment}
                          </p>
                        </div>
                      ))
